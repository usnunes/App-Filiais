                ...
                <form action="{{route('filial.store')}}" method="post">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-6 col-sm-12">
                            ...
                            <input type="text" required class="form-control @error('nome') is-invalid @enderror" value="{{old('nome')}}" name="nome" id="nome">
                            @error('nome')
                        ...
                        <div class="form-group col-lg-6 col-sm-12">
                            ...
                            <input type="text" required class="form-control @error('endereco') is-invalid @enderror" value="{{old('endereco')}}" name="endereco" id="endereco">
                            @error('endereco')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-lg-4 col-sm-12">
                            ...
                            <input type="text" required class="form-control @error('cidade') is-invalid @enderror" value="{{old('cidade')}}" name="cidade" id="cidade">
                            @error('cidade')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
                        ...
                        <div class="form-group col-lg-4 col-sm-12">
                            ...
                            <input type="text" required class="form-control @error('cnpj') is-invalid @enderror" value="{{old('cnpj')}}" name="cnpj" id="cnpj">
                            @error('cnpj')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
                        ...
                        <div class="form-group col-lg-4 col-sm-12">
                            ...
                            <input type="email" required class="form-control @error('email') is-invalid @enderror" value="{{old('email')}}" name="email" id="email">
                            @error('email')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-lg-4 col-sm-12">
                            ...
                            <input type="text" required class="form-control @error('latitude') is-invalid @enderror" value="{{old('latitude')}}" name="latitude" id="latitude">
                            @error('latitude')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
                        ...
                        <div class="form-group col-lg-4 col-sm-12">
                            ...
                            <input type="text" required class="form-control @error('longitude') is-invalid @enderror" value="{{old('longitude')}}" name="longitude" id="longitude">
                            @error('longitude')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
